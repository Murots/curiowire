...
export default function PrivacyPage() {
  ...
  const breadcrumbItems = [{ label: "Home", href: "/" }, { label: "Privacy" }];
    ...
    <>
      ...
      <MainWrapper>
        <Wrapper>
          ...
          <Paragraph>
            This Privacy Policy explains how <strong>CurioWire</strong>{" "}
            collects, uses, and protects personal information when you visit our
            website or interact with our content. We are committed to
            transparency and to handling all data in accordance with the{" "}
          ...
          <Paragraph>
            When contacting us directly by email, the message and address you
            use are stored solely for the purpose of responding to your inquiry.
          </Paragraph>
          ...
          <Paragraph>
            ...
            Ezoic) may set their own cookies to measure ad performance and
            prevent fraud.
          </Paragraph>
          ...
          <Paragraph>
            ...
            users. These links may contain anonymized tracking codes solely used
            for attribution.
          </Paragraph>
          ...
          <Paragraph>
            ...
            party. Access to stored logs and analytics is restricted to
            essential administrators only.
          </Paragraph>
          ...
          <Paragraph>
            ...
            operations or legal requirements. The date of the latest revision
            will always be displayed below.
          </Paragraph>
