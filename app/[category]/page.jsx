...
//       .select(
//         "id, category, title, summary_normalized, image_url, created_at, wow_score, article_type, quote_text, seo_title, seo_description, videos(youtube_video_id, youtube_url, posted_at, posted_results, status)",
//       )
//       .eq("status", "published")
//       .eq("is_listed", true)
...
//     description: `Latest ${category} curiosities on CurioWire.`,
//     mainEntityOfPage: { "@id": `${collectionUrl}#collection` },
    ...
    : sortQ === "trending"
      ...
      : sortQ === "random"
        ...
        : sortQ === "lists"
          ? `${label} list curiosities on CurioWire.`
          : sortQ === "quote"
            ? `${label} quote curiosities on CurioWire.`
            : sortQ === "video"
              ? `${label} curiosities with video on CurioWire.`
              : sortQ === "wow"
                ? `Top-rated ${label.toLowerCase()} curiosities on CurioWire.`
