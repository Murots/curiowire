// // ============================================================================
// // whisperWordSubtitles.js — PRO TikTok subtitles 2025
// // - whisper-1 word-perfect timing
// // - Kinetic pop-in captions (center screen)
// // - Dual-glow neon effect (outline + halo)
// // - Keyword highlighting + number neon
// // ============================================================================
...
//   console.log("📝 Transcribing with whisper-1 for PRO kinetic captions…");
...
//   // ============================================================================
//   // ASS HEADER — 2025 TikTok Kinetic Style
//   // ============================================================================
//   const header = [
//     "[Script Info]",
//     "ScriptType: v4.00+",
...
//     // Alignment 5 = center
//     // MarginV=250 = perfect mid-screen placement
//     // outline=6 gives strong base glow
//     "Style: Kinetic,Playfair Display,100,&H00FFFFFF,&H000000FF,&H00202020,&H64000000," +
//       "-1,0,0,0,100,100,0,0,1,6,0,5,80,80,250,1",
...
//     let end = typeof w.end === "number" && w.end > start ? w.end : start + 0.14;
...
//       // Neon cyan halo for numbers
//       neonHalo = "\\2c&H00FFFF& \\t(0.15,0.35,\\2c&H55FFFF&)";
//     } else if (HIGHLIGHT_WORDS.includes(lower)) {
//       // Warm green/yellow neon halo for keywords
//       neonHalo = "\\2c&H33FF55& \\t(0.15,0.35,\\2c&H66FF99&)";
//     } else {
//       // Soft blue halo for normal words
//       neonHalo = "\\2c&HCCCCFF& \\t(0.10,0.30,\\2c&HFFFFFF&)";
//     }

//     // ============================================================================
//     // POP-IN Kinetic Motion (subtle)
//     // ============================================================================
//     const pop = "\\fscx90\\fscy90\\t(0.06,0.18,\\fscx100\\fscy100)";

//     // ============================================================================
//     // BASE GLOW (outline + soft blur)
//     // ============================================================================
//     const glow = "\\bord6\\blur5\\shad0\\3c&H000000&";

//     // Final styling block
//     const styled = `{${neonHalo}${pop}${glow}}${safe}`;
...
//   console.log("💬 PRO kinetic neon captions generated:", assPath);
//   return assPath;
// }
// ============================================================================
