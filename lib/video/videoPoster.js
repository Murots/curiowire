...
// ============================================================================
// lib/video/videoPoster.js — v2.3 CurioWire Production
// Social Video Poster
// ============================================================================
// - Auto caption + hashtags
// - YouTube Shorts upload
// - NEW: auto-generate and upload custom YouTube thumbnail
// ============================================================================
...
async function postToYouTubeShorts(videoPath, caption, article) {
  ...
  try {
    ...
    log(
      `🖼️ [YouTube] Thumbnail ready | hook="${thumbnail.hook}" | color=${thumbnail.signalColor}`,
    );
  } catch (err) {
