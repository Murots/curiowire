...
`;
  ...
  try {
    ...
    if (noun === "symbol") {
      if (title.toLowerCase().includes("ziggurat")) return "ziggurat";
      if (title.toLowerCase().includes("temple")) return "temple";
      if (title.toLowerCase().includes("ruins")) return "ancient ruins";
      if (title.toLowerCase().includes("manuscript"))
        return "ancient manuscript";
    }
