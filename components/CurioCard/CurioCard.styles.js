...
// export const QuoteCardHero = styled.div`
//   position: relative;
//   width: 100%;
//   height: 100%;
...
// export const QuoteCardKicker = styled.div`
//   margin-bottom: 12px;
//   font-size: 0.68rem;
//   font-weight: 800;
...
// export const QuoteCardText = styled.div`
//   margin: 0;
//   color: white;
//   font-family: "Playfair Display", serif;
...
// export const QuoteBadge = styled.div`
//   position: absolute;
//   right: 12px;
//   top: ${({ $offset = 12 }) => `${$offset}px`};
//   z-index: 3;
...
export const ImageWrapper = styled.div`
  position: relative;
  overflow: hidden;
  background-color: ${({ $portrait }) => ($portrait ? "#111" : "#eaeaea")};
...
export const PortraitBackdrop = styled.div`
  position: absolute;
  inset: 0;
  z-index: 0;
...
export const Image = styled.img`
  ...
  ${CardLink}:hover & {
    transform: ${({ $portrait }) =>
      $portrait ? "scale(1.02)" : "scale(1.04)"};
    filter: brightness(1.06);
  }
`;
