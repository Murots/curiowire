...
//     <figure class="cw-inline-image">
//       <div class="cw-inline-image__wrap">
//         <img
//           src="${card.image_url}"
//           alt="${cleanText(card.title || card.quote_text || "Quote article image")}"
//           loading="lazy"
//           decoding="async"
//           class="cw-inline-image__img"
//         />
//       </div>
//       ${
//         creditText
...
//     secondParagraph,
//     `${secondParagraph}${inlineImageHtml}`,
//   );
// }
...
// function extractSummaryWho(summaryHtml) {
//   const s = String(summaryHtml || "");
//   const match = s.match(/<span[^>]*data-summary-who[^>]*>([\s\S]*?)<\/span>/i);

//   if (!match?.[1]) return null;

//   return cleanText(match[1]).replace(/\.$/, "").trim() || null;
// }
...
//   const quoteAttribution = useMemo(
//     () => extractSummaryWho(card.summary_normalized),
//     [card.summary_normalized],
//   );
...
//     const withBreak = injectArticleBreakIntoCardText(
//       card.card_text || "",
//       articleBreak,
//     );
...
//       {isQuoteArticle ? (
//         <QuoteHeroWrap $bg={quoteHeroBg}>
//           <QuoteHeroInner>
//             <QuoteHeroKicker>Quote Explained</QuoteHeroKicker>
//             <QuoteHeroText>{cleanText(card.quote_text || "")}</QuoteHeroText>
//             {quoteAttribution ? (
//               <QuoteHeroAttribution>— {quoteAttribution}</QuoteHeroAttribution>
//             ) : null}
//           </QuoteHeroInner>
//         </QuoteHeroWrap>
//       ) : card.image_url ? (
